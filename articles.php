                        ...
                        <div class="block">
                            ...
                            <div class="block__content">
                                ...
                                if ($articles_exist == true) {
                                    ...
                                    if (isset($_GET['category'])) {
                                        if ($page > 1) {
                                            echo '<a href="/articles.php?category=' . $category . '&page=' . ($page - 1) . '">&laquo; Previous page   </a>';
                                        }
                                        if ($page < $total_pages) {
                                            echo '<a href="/articles.php?category=' . $category . '&page=' . ($page + 1) . '"> Next page &raquo;</a>';
                                        }
                                    } else {
                                        if ($page > 1) {
