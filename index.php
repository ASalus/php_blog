      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div class="block">
              <a href="/articles.php?category=7">All articles</a>
              <h3>Safety [Newest]</h3>
              <div class="block__content">
                <div class="articles articles__horizontal">

                <?php  
                  $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `category_id` = 7 ORDER BY `id` DESC LIMIT 10");
            ...
            <div class="block">
              <a href="/articles.php?category=3">All articles</a>
